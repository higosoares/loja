...
// Returns the private 'App\Repository\TipoPerfilRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoPerfilRepository.php';

return $this->privates['App\Repository\TipoPerfilRepository'] = new \App\Repository\TipoPerfilRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
