...
// Returns the private 'App\Repository\PerfilRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PerfilRepository.php';

return $this->privates['App\Repository\PerfilRepository'] = new \App\Repository\PerfilRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
