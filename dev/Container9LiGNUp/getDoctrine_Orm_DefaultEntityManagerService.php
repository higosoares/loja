...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\PerfilRepository' => function () {
    return ($this->privates['App\Repository\PerfilRepository'] ?? $this->load('getPerfilRepositoryService.php'));
}, 'App\\Repository\\TipoPerfilRepository' => function () {
    return ($this->privates['App\Repository\TipoPerfilRepository'] ?? $this->load('getTipoPerfilRepositoryService.php'));
}))));
