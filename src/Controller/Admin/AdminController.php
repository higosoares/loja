...
class AdminController extends AbstractController
{
    ...
    /**
     * @Route("/compra/cadastrar", name="admin_cadastrar_compra")
     */
    ...
    /**
     * @Route("/compras", name="admin_compras")
     */
    ...
    /**
     * @Route("/compra/editar/{id}", name="admin_compra_editar")
     */
    ...
    /**
     * @Route("/compra/detalhes/{id}", name="admin_compra_detalhes")
     */
    ...
    /**
     * @Route("/compra/deletar/{id}", name="admin_compra_deletar")
     */
