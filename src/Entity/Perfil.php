 ...
 * @ORM\Table(name="perfil", indexes={@ORM\Index(name="fk_perfil_tipo_perfil1_idx", columns={"cod_tipo_perfil"}), @ORM\Index(name="fk_perfil_cliente1_idx", columns={"cod_cliente"})})
 */
class Perfil
{
    /**
